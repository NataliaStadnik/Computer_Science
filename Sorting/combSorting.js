// представляет собой еще один улучшенный вариант сортировки пузырьком.
...
// Во вторых, это расстояние должно постепенно уменьшиться до 1, чтобы на последней итерации цикла мы смогли
